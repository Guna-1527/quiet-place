...
const Guide = () => {
  return (
    <div className="w-full h-[400px] flex flex-col p-12 items-center bg-gray-100">
      <h1 className="text-xl font-bold ">How to get started?</h1>
      <div className="flex flex-wrap justify-around gap-10 mt-10">
        {GuideType.map((item) => (
          <div
            key={item.id}
            className="flex w-[330px] justify-center text-center items-center flex-col rounded-md shadow-lg px-8 py-4"
          >
